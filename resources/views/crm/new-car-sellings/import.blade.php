...
@section("content")
	<div class="x_panel">
		<div class="x_title">
			<div class="row">
				<div class="col-xs-12">
					<h2 class="font-bold">Új autó eladások - CSV fájl feltöltése</h2>
				</div>
			</div>
		</div>
		<div class="x_content">
			<form class="form-horizontal form-label-left" action="<?php echo $GLOBALS["URL"]->currentURL; ?>" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					<div class="col-xs-12 text-center">
						...
						<a class="btn btn-lg btn-dark display-block-xs" href="<?php echo PATH_WEB; ?>ujautoeladas_demo.csv"><i class="fa fa-download"></i> &nbsp;Demó CSV</a>
