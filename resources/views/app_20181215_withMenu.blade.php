...
<body>
	<?php if(true) { ?>
		...
		<header id="main-header">
			...
			<a id="main-header-menu-open" onclick="menuOpen();"><i class="fa fa-bars"></i></a>
		...
		<div id="main-navigation" class="transition">
			<div id="main-navigation-inner" class="main-navigation-inner">
				<div id="main-logo"><img src="<?php echo PATH_WEB; ?>pics/logo-gablini.png" class="img-responsive center" alt="Gablini Kft."></div>
				<nav id="main-menu" class="main-menu">
					...
					{
						$active = ($url == $GLOBALS["URL"]->routes[0]) ? true : false;
						?><li class="main-menu-li"><a href="<?php echo PATH_WEB.$url; ?>" class="main-menu-a<?php if($active) { ?> main-menu-a-active<?php } ?>"><?php echo $name; ?></a></li><?php
					}
					?>
					<li class="clear main-menu-li-clear"></li>
				</ul>
				<div class="clear"></div>
				</nav>
			</div>
		...
		function menuOpen()
		{
			$("#main-navigation").addClass("main-navigation-opened");
		}
		
		function menuClose()
		{
			$("#main-navigation").removeClass("main-navigation-opened");
		}
		
		$("#main-navigation").click(function(){
			menuClose();
		}).children().click(function(e) {
			if($(e.target).attr("class") != "main-menu-a") return false;
		});
