...
<head>
	...
	<link href="<?php echo PATH_WEB; ?>css/gablini-app.css?v=20201014" rel="stylesheet">
...
<body <?php if(isset($VIEW["bodyID"])) { ?>id="body-<?php echo $VIEW["bodyID"]; ?>"<?php } ?> class="@yield('bodyClass')">
	@yield("bodyTop")
	
	<header id="main-header">
		<?php /* if(isset($GLOBALS["URL"]->routes[0]) AND !empty($GLOBALS["URL"]->routes[0])) { ?><div id="main-header-logo"><img src="<?php echo PATH_WEB; ?>pics/logo-gablini-2020-app.png" alt="Gablini Kft." class="img-responsive center"></div><?php }*/ ?>
		<div id="main-header-title"><?php echo $VIEW["title"]; ?></div>
		<a id="main-header-menu-open" class="transition" href="<?php echo PATH_WEB; ?>"><i class="fa <?php if(isset($GLOBALS["URL"]->routes[0]) AND !empty($GLOBALS["URL"]->routes[0])) { ?>fa-chevron-left<?php } else { ?>fa-home<?php } ?>"></i></a>
		<?php /*
		<a id="main-header-others-open" class="transition" onclick="headerMenuToggle();"><i class="fa fa-ellipsis-v"></i></a>
