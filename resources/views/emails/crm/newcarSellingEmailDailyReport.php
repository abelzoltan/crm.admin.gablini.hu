...
$stats["events"] = ["name" => "<strong>ÁTADÁSOK SZÁMA</strong>", "value" => 0];
...
{
	if(date("N") == 5) { $addressListURL = "crm-ujauto-napi-jelentes-teljes-pentek"; }
	else { $addressListURL = "crm-ujauto-napi-jelentes-teljes"; }
}
else
{
	...
	switch($brand->brand)
	{
		...
		case "kia":
		case "hyundai":
			$addressListURL = "crm-ujauto-napi-jelentes-".$brand->brand;
			break;
		default: $addressListURL = "crm-ujauto-napi-jelentes-teljes"; break;
	}
}
