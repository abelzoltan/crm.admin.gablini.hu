...
#Sending datas
$emailController->subject = "[GABLINI-CRM] Havi kitöltési adatok";
$emailController->body = $emailController->setBody("crm/service_monthly_fillings_stats");

$webAddresses = new \App\Http\Controllers\WebAddressController;
$addressList = $webAddresses->getAddressesForSendingByURL("crm-szerviz-havi-kitoltesi-adatok");
