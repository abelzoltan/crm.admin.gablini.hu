...
#Sending datas
$emailController->subject = "[GABLINI-CRM] Új autó átadás - heti statisztikák";
$emailController->body = $emailController->setBody("crm/newcar_sellings_weekly_stats");

$webAddresses = new \App\Http\Controllers\WebAddressController;
$addressList = $webAddresses->getAddressesForSendingByURL("crm-ujauto-heti-statisztikak");
