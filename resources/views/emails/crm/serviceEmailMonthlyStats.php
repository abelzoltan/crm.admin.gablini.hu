...
#Sending datas
$emailController->subject = "[GABLINI-CRM] Havi statisztikák";
$emailController->body = $emailController->setBody("crm/service_monthly_stats");

$webAddresses = new \App\Http\Controllers\WebAddressController;
$addressList = $webAddresses->getAddressesForSendingByURL("crm-szerviz-havi-statisztikak");
